...
var mutation_options = [
	...
	{"mutation": 0.01, "purchased": false, "price": 4},
	{"mutation": 0.02, "purchased": false, "price": 5},
	{"mutation": 0.03, "purchased": false, "price": 6},
	{"mutation": 0.04, "purchased": false, "price": 7},
	{"mutation": 0.05, "purchased": false, "price": 8},
	{"mutation": 0.10, "purchased": false, "price": 8},
	{"mutation": 0.005, "purchased": false, "price": 10},
	{"mutation": 0.001, "purchased": false, "price": 10},
]

var previous_topk_idx: int = 0
var topk_options = [
	{"topk": 0.25, "purchased": true},
	{"topk": 0.10, "purchased": false, "price": 4},
	{"topk": 0.08, "purchased": false, "price": 4},
	{"topk": 0.05, "purchased": false, "price": 8},
	{"topk": 0.04, "purchased": false, "price": 8},
	{"topk": 0.02, "purchased": false, "price": 8},
	{"topk": 0.01, "purchased": false, "price": 8},
	{"topk": 3, "purchased": false, "price": 8},
	{"topk": 2, "purchased": false, "price": 8},
	{"topk": 1, "purchased": false, "price": 8},
]
...
func get_mutation_text(meta) -> String:
	...
	var out: String
	if mutation > 0:
		out = "%.1f%% Mutation" % (meta['mutation']*100.0)
	else:
		out = "No Mutation"
